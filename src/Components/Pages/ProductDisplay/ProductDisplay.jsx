...
function ProductDisplay() {
  ...
  const product = items.find(prod => prod.slug === params.slug);
      ...
      <div className="product-display-container">
        ...
        <div className="product-display-info">
          ...
          <BodyText style={{ fontWeight: 'bold' }}>
            Cleaner, all natural, skin-care solutions
          </BodyText>
          <BodyText3 style={{ marginBottom: 20 }}>
            Our custom Vitiligio Balm works for all skin types. Clean ingredients keep you confident
            that you’re using only the best solutions for your skin.
          </BodyText3>
