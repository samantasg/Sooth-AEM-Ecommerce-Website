...
function About() {
    return (
        <div>
            ...
            <Section bgColor="#A67744"><ShopMore background={Image4} title="Clean products that deliver better solutions" info="A healthier you from the inside out. We’ve sourced the cleanest ingredients to create a line of clean skin care treatments that leave you feeling your best"></ShopMore></Section>
        </div>
    )
}
